		...
		<?php if(isset($sidebar)): ?>
		  ...
		  <div class="col-md-10">
		  	<div class="content-box-large">
				...
				<?php if(!empty($this->session->flashdata('service_created'))): ?>
				<div class="alert alert-success" role="alert">
				  <?php echo $this->session->flashdata('service_created');  ?>
				</div>
				<?php endif; ?>
				<?php if(!empty($this->session->flashdata('service_delete_success'))): ?>
				<div class="alert alert-success" role="alert">
				  <?php echo $this->session->flashdata('service_delete_success');  ?>
				</div>
				<?php endif; ?>
				<?php if(!empty($this->session->flashdata('service_update_success'))): ?>
				<div class="alert alert-success" role="alert">
