         ...
         <fieldset>
          <div class="row">
            ...
            <div class="form-group col-md-6">
              <div class="input-group" >
                <input style="margin:0" type="text" name="input-arrival-date" class="form-control datepicker_ar" placeholder="Arrival Date" value="<?=$master_data['input-arrival-date']?>" >
            ...
            <div class="form-group col-md-6">
              <div class="input-group" >
                <input style="margin:0" type="text" name="input-departure-date" class="form-control datepicker_dep" placeholder="Deaparture Date" value="<?=$master_data['input-departure-date']?>">
          ...
          <div class="bhoechie-tab-content">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <textarea class="form-control" name="text-current-address" placeholder="Present Address" rows="3"><?=$master_data['text-current-address']?></textarea>
                </div>
                <div class="form-group">
                  <input type="text" disabled class="form-control" name="input-current-country" placeholder="Country" value="<?php if(!empty($country_list)): foreach($country_list as $country):  if($master_data['living_in']==$country['id']){ echo $country['country_name']; } endforeach; endif; ?>" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                ...
                <div class="form-group">
                  <div class="input-group"> <span class="input-group-addon">
                    <?php if(!empty($country_list)): foreach($country_list as $country):  if($master_data['living_in']==$country['id']){ echo $country['phone_code']; } endforeach; endif; ?>
                    </span>
                    <input type="text" class="form-control" style="margin:0" name="input-current-mobile" pattern="/d{10}/" value="<?=$master_data['input-current-mobile']?>" placeholder="Cell" />
                  </div>
                </div>
                <div class="form-group">
                  <input type="email" class="form-control" name="input-email" value="<?=$master_data['input-email']?>" placeholder="Email-id" />
                </div>
              </div>
            </div>
            </fieldset>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <select class="form-control-input" name="select-emirates">
                    ...
                    <option value="Abu-Dhabi" <?php if($master_data['select-emirates'] == 'Abu-Dhabi'){ echo "selected"; }?>>Abu Dhabi</option>
                    <option value="Ajman" <?php if($master_data['select-emirates'] == 'Ajman'){ echo "selected"; }?>>Ajman</option>
                    <option value="Al-Fujerah" <?php if($master_data['select-emirates'] == 'Al-Fujerah'){ echo "selected"; }?>>Al Fujerah</option>
                    <option value="Dubai" <?php if($master_data['select-emirates'] == 'Dubai'){ echo "selected"; }?>>Dubai</option>
                    <option value="Ras-Al-Khaimah" <?php if($master_data['select-emirates'] == 'Ras-Al-Khaimah'){ echo "selected"; }?>>Ras Al Khaimah</option>
                    <option value="Sharjah" <?php if($master_data['select-emirates'] == 'Sharjah'){ echo "selected"; }?>>Sharjah</option>
                    <option value="Umm-Al-Quwain" <?php if($master_data['select-emirates'] == 'Umm-Al-Quwain'){ echo "selected"; }?>>Umm Al Quwain</option>
                  </select>
                </div>
                <div class="form-group">
                  <input type="text" class="form-control" name="input-current-phone" placeholder="Phone" value="<?=$master_data['input-current-phone']?>" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <textarea class="form-control" name="text-hotel-address" placeholder="UAE Hotel Address" rows="3"><?=$master_data['text-hotel-address']?>
</textarea>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <input type="text" class="form-control" name="input-emergency-person" placeholder="Name" value="<?=$master_data['input-emergency-person']?>" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <input type="text" class="form-control" name="input-emergency-number" placeholder="Cell" value="<?=$master_data['input-emergency-number']?>" />
                </div>
              </div>
            </div>
            </fieldset>
          ...
          <div class="row">
            <div class="col-md-12">
              <legend>Applicant # <span id="applicant_counter"><?=($applicant_no+2)?></span> </legend>
            </div>
            <div class="col-md-6">
              <div class="form-group">
